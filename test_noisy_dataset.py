...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_past', type=int, default=12, help='Number of past timesteps (default: 12).')
    parser.add_argument('--n_future', type=int, default=3, help='Number of future timesteps (default: 3).')
    ...
    test_workload_pred_noisy_data(
        args.model_path, args.n_past, args.n_future, args.test_microservice_id,
        args.reverse_test_data, args.num_runs, args.seeds
    )
