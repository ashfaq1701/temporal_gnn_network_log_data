...
if [ -z "$1" ]; then
  echo "Usage: $0 <model_base_path> <output_base_dir> <test_microservice_id> <train_microservice_id> [should_reverse_data] [seeds]"
  exit 1
fi
