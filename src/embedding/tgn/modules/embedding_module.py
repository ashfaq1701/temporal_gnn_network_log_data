...
from src.embedding.tgn.model.temporal_attention import TemporalAttentionLayer
from src.embedding.tgn.utils.utils import get_node_features
...
class TimeEmbedding(EmbeddingModule):
    def __init__(self, memory, neighbor_finder, time_encoder, n_layers,
        ...
        super(TimeEmbedding, self).__init__(memory, neighbor_finder, time_encoder, n_layers,
...
class GraphEmbedding(EmbeddingModule):
    ...
    def compute_embedding(self, memory, source_nodes, timestamps, n_layers, n_neighbors=20, time_diffs=None,
        ...
        source_node_features = get_node_features(source_nodes, self.n_node_features)
...
class GraphSumEmbedding(GraphEmbedding):
    def __init__(self, memory, neighbor_finder, time_encoder, n_layers,
                 n_node_features, n_edge_features, n_time_features, embedding_dimension, device,
                 n_heads=2, dropout=0.1, use_memory=True):
        super(GraphSumEmbedding, self).__init__(memory=memory,
...
class GraphAttentionEmbedding(GraphEmbedding):
    def __init__(self, memory, neighbor_finder, time_encoder, n_layers,
                 n_node_features, n_edge_features, n_time_features, embedding_dimension, device,
                 n_heads=2, dropout=0.1, use_memory=True):
        super(GraphAttentionEmbedding, self).__init__(memory, neighbor_finder, time_encoder,
                                                      n_layers, n_node_features, n_edge_features,
...
def get_embedding_module(module_type, memory, neighbor_finder, time_encoder, n_layers, n_node_features,
                         n_edge_features, n_time_features, embedding_dimension, device, n_heads=2, dropout=0.1,
                         n_neighbors=None, use_memory=True):
    if module_type == "graph_attention":
        return GraphAttentionEmbedding(memory=memory,
                                       neighbor_finder=neighbor_finder,
        ...
        return GraphSumEmbedding(memory=memory,
                                 neighbor_finder=neighbor_finder,
                                 time_encoder=time_encoder,
                                 n_layers=n_layers,
                                 n_node_features=n_node_features,
        ...
        return IdentityEmbedding(memory=memory,
                                 neighbor_finder=neighbor_finder,
                                 time_encoder=time_encoder,
                                 n_layers=n_layers,
                                 n_node_features=n_node_features,
        ...
        return TimeEmbedding(memory=memory,
                             neighbor_finder=neighbor_finder,
                             time_encoder=time_encoder,
                             n_layers=n_layers,
                             n_node_features=n_node_features,
