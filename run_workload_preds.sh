...
python3 main.py --task predict_workload --d_model $d_model --only_use_target_microservice --seq_len 240 --label_len 120 --pred_len 60 --microservice_id $microservice_id --patience 5 --n_runs $n_runs --output_dir "$full_dir/univariate_with_embedding_long_range_pred_60/" --embedding_scaling_type "$embedding_scaling_type" --embedding_scaling_factor $embedding_scaling_factor
